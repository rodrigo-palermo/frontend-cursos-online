...
<script>
    ...
    export default {
        ...
        created() {
            ...
            window.console.log('CREATED - list',this.usuarios)
        },
        ...
        data() {
            return {
                ...
                fields: [
                    ...
                    {key: 'perfil_nome', label: 'Perfil', sortable: true},
                    'email',
                    'senha',
        ...
        methods: {
            ...
            async onDelete() {
                this.$store.dispatch('usuarios/deleteUsuario', this.selected.id);
